...
function createFormControl(props = {}) {
  ...
  const register = (name, options = {}) => {
    ...
    field ? isBoolean(options.disabled) && set(_formValues, name, options.disabled ? void 0 : get(_formValues, name, getFieldValue(field._f))) : updateValidAndValue(name, true);
    return Object.assign(Object.assign(Object.assign({}, isBoolean(options.disabled) ? {disabled: options.disabled} : {}), _options.shouldUseNativeValidation ? {
      ...
      ref: (ref) => {
        if (ref) {
          ...
          set(_fields, name, {
            _f: radioOrCheckbox ? Object.assign(Object.assign({}, field._f), {refs: [...compact(field._f.refs).filter(live), fieldRef], ref: {type: fieldRef.type, name}}) : Object.assign(Object.assign({}, field._f), {ref: fieldRef})
          });
